...
public class AdvancedQuizActivity extends AppCompatActivity {
    ...
    private String[] questions = {"Which sorting algorithm is best suited for sorting linked lists?", "Which sorting algorithm is NOT in-place?", "Which sorting algorithm has the worst-case time complexity of O(n log n)?", "Which sorting algorithm is NOT a comparison-based sorting algorithm?", "Which sorting algorithm is used in Python’s built-in sorted() function?"};

    private String[][] options = {{"Quick Sort", "Merge Sort", "Bubble Sort", "Heap Sort"}, {"Quick Sort", "Merge Sort", "Heap Sort", "Selection Sort"}, {"Quick Sort", "Merge Sort", "Heap Sort", "Counting Sort"}, {"Quick Sort", "Counting Sort", "Merge Sort", "Selection Sort"}, {"Quick Sort", "Merge Sort", "Timsort", "Heap Sort"}};

    private int[] correctAnswers = {1, 1, 2, 1, 2};

    private String[] explanations = {

            "Merge Sort is best suited for linked lists because it does not require random access to elements.", "Merge Sort is NOT an in-place sorting algorithm since it requires additional space for merging.", "Heap Sort has the worst-case time complexity of O(n log n), which is guaranteed for all cases.", "Counting Sort is NOT a comparison-based algorithm, as it works by counting occurrences of elements.", "Python's built-in sorted() function uses Timsort, a hybrid of Merge Sort and Insertion Sort."};
